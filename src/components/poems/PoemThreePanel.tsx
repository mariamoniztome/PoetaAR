...
export default function PoemThreePanel({ poem }: PoemPanelProps) {
  return (
    <motion.section
      className="h-screen w-full flex flex-col items-center justify-center bg-[#f5f0f0] relative overflow-hidden"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <div className="max-w-xl px-8 relative z-10 text-center">
        <span className="font-serif italic text-6xl opacity-10 absolute -bottom-12 -left-12 select-none">
          {poem.marker.roman}
        </span>
